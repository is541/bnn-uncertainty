...
class LinearGaussian(nn.Module):
    ...
    def compute_kl(self):
        # print("compute KL from LinearGaussian")
...
class DeterministicGaussian(LinearGaussian):
    def __init__(self, in_features, out_features, certain=False,
        ...
        :param certain:  if true, than x is equal to its mean and has no variance
        """
        # print("Init DeterministicGaussian")
    ...
    def compute_kl(self):
        # print("Return KL=0 from DeterministicGaussian")
        return 0
...
class DeterministicReluGaussian(ReluGaussian):
    def __init__(self, in_features, out_features, certain=False,
        ...
        :param certain:  if true, than x is equal to its mean and has no variance
        """
        # print("Init DeterministicReLuGaussian")
    ...
    def compute_kl(self):
        # print("Return KL=0 from DeterministiReLuGaussian")
        return 0
...
class VarianceGaussian(LinearGaussian):
    ...
    def compute_kl(self):
        # print("Return KL=0 from VarianceGaussian")
        return 0
...
class VarianceReluGaussian(ReluGaussian):
    def __init__(self, in_features, out_features,
                 certain=False, deterministic=True, sigma_sq=False):
        super().__init__(in_features, out_features, certain, deterministic)
        # print("Init VarianceReluGaussian")
        self.W.data.fill_(0)
        self.W.requires_grad = False
        self.sigma_sq = sigma_sq
        if sigma_sq:
    ...
    def compute_kl(self):
        # print("Return KL=0 from VariancReLuGaussian")
        return 0
